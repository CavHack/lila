...
#ifndef H264HEISENBERG_SEQ_PARAM_SET_H
#define H264HEISENBERG_SEQ_PARAM_SET_H
...
u32 h264BASCompareSeqParamSets(seqParamSet_t *pSps1, seqParamSet_t *pSps2);

#endif /* #ifdef H264HEISENBERG_SEQ_PARAM_SET_H */
